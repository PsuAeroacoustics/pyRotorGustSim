...
def build_blade_geom(geom_params,input_params,res_param,observer_params,acs_params,saved_params):
    ...
    af.coordinates = af.repanel(n_points_per_side = int(input_params['computational_params']['airfoil_elements']/2)).coordinates*saved_params['c']
    ...
    saved_params.update({'blade_nodes':blade_nodes[:,1:-1],'blade_norms':blade_norms[:,1:-1]})
