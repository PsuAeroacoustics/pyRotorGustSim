...
def compute_aero(geom_params,input_params,observer_params,acs_params,saved_params):
    ...
    saved_params.update({'t':t,'iterations':iterations,'psi':psi,'h_gust':h,'v_gust':v_gust,'s':s,'th0':th0,'CL':CL,'CD':CD,'aoa_eff':aoa_eff,'dCT':dCT,'dCP':dCP,'loads':loads,'lifting_line_nodes':lifting_line_nodes,'lifting_line_norms':lifting_line_norms})
